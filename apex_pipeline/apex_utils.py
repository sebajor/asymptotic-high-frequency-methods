...
def APEX_generate_screw_table(coeffs, screw_file='cfg/screw_table.csv', limit_microns=10, screw_lead=36./25,
    ...
    for panel, act_x, act_y, xtext, ytext in zip(panel_num, x,y,x_text, y_text):
        ...
        deform, _, _ = deform_function(x_, y_, panel_coeffs)    ##deform are in m!
