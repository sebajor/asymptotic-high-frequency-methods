...
grasp_file = '~/GRASP_sim/focus_15mm/focus_15mm.npz'
...
(p_pos, p_n, p_ds), (s_pos, s_n, s_ds, sec_vertex), B, s_focus = cassegrain_cylindrical_cone(pr_v, pt_v, sr_v, st_v,
                           f1, f_d)
...
##normalize the beam
peak = np.argmax(np.abs(E_p_k))
E_p_k = E_p_k/E_p_k[peak]
